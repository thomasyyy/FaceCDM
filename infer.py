...
from pipeline_stable_diffusion_xl_faceid import StableDiffusionXLInstantIDPipeline, draw_kps
...
if __name__ == "__main__":
    ...
    face_adapter = '/root/instantid_diffusers_train/InstantID_train/checkpoints/ip-adapter.bin'
    controlnet_path = '/root/instantid_diffusers_train/InstantID_train/checkpoints/ControlNetModel'
    ...
    face_image = load_image("/root/w700d1q75cms.jpg").convert('RGB')
